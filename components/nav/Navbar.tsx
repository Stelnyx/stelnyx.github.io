...
export function Navbar() {
  ...
  return (
    <header
      className={`sticky top-0 z-50 h-16 flex items-center border-b transition-all duration-200 ${
        scrolled
          ? "bg-stel-bg/95 border-stel-border-bright backdrop-blur-md"
          : "bg-stel-bg/80 border-stel-border/50 backdrop-blur-md"
      }`}
    >
      <div className="w-full max-w-[1280px] mx-auto px-6 md:px-12 xl:px-20 flex items-center justify-between">
        ...
        >
          <StarMark />
          <span
            className="font-sans font-semibold text-[18px] text-stel-text-primary tracking-tight"
          >
            Stelnyx
          </span>
        </a>
        ...
        >
          <span
            className={`block w-5 h-0.5 bg-stel-text-primary transition-all duration-200 ${
      ...
      <div
        ...
        aria-modal="true"
        className={`fixed top-16 right-0 bottom-0 z-50 w-72 bg-stel-surface border-l border-stel-border md:hidden flex flex-col px-6 py-8 gap-6 transition-transform duration-200 ${
