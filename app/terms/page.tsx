        ...
        <div className="max-w-[720px] mx-auto px-6 md:px-12 py-24">
          ...
          <div className="space-y-12">
            ...
            <Section title="Open source tools">
              ...
              <p>
                Lucen and LuxFaber are proprietary software currently in development. Access is restricted. Do not redistribute, reverse engineer, or use these tools without explicit written permission from Stelnyx.
              </p>
            </Section>
